...
public class PreferencesController {
	...
	try {
	    Preferences _preferences = prefRepo.save(
		    new Preferences(preferences.getId(), preferences.getRaidsPerWeek(), preferences.isSeekingGuild(),
			    preferences.isSeekingRaid(), preferences.getDescription(), preferences.getObjectives(),
			    preferences.getLootSystems()));
